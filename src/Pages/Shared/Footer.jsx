  ...
  return (
    ...
    <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
          <img src="https://img.freepik.com/free-vector/detailed-travel-logo_23-2148616611.jpg?size=338&ext=jpg&ga=GA1.1.553209589.1714435200&semt=ais" className="mr-5 w-32  h-32 sm:h-20" alt="logo" />
          <p className="max-w-xs mt-4 text-sm text-gray-600">
            Leave the ordinary behind and escape to paradise with our collection of exclusive travel experiences. Whether you're craving a luxurious beach retreat
          </p>
